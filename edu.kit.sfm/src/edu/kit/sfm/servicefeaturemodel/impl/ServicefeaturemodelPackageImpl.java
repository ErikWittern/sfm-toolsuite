...
public class ServicefeaturemodelPackageImpl extends EPackageImpl implements ServicefeaturemodelPackage {
	 ...
	 * @see edu.kit.sfm.servicefeaturemodel.ServicefeaturemodelPackage#eNS_URI
	 * @see #init()
	 * @generated
	 */
	...
	public void initializePackageContents() {
		...
		initEClass(orEClass, edu.kit.sfm.servicefeaturemodel.OR.class, "OR", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
		initEAttribute(getOR_MinFeaturesToChoose(), ecorePackage.getEInt(), "minFeaturesToChoose", null, 0, 1, edu.kit.sfm.servicefeaturemodel.OR.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getOR_MaxFeaturesToChoose(), ecorePackage.getEInt(), "maxFeaturesToChoose", null, 0, 1, edu.kit.sfm.servicefeaturemodel.OR.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

		initEClass(xorEClass, edu.kit.sfm.servicefeaturemodel.XOR.class, "XOR", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
