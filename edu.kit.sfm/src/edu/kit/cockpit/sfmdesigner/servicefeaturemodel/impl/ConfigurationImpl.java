 ...
 *   <li>{@link edu.kit.cockpit.sfmdesigner.servicefeaturemodel.impl.ConfigurationImpl#getServiceFeatures <em>Service Features</em>}</li>
 *   <li>{@link edu.kit.cockpit.sfmdesigner.servicefeaturemodel.impl.ConfigurationImpl#getPreferences <em>Preferences</em>}</li>
 *   <li>{@link edu.kit.cockpit.sfmdesigner.servicefeaturemodel.impl.ConfigurationImpl#getAttributes <em>Attributes</em>}</li>
