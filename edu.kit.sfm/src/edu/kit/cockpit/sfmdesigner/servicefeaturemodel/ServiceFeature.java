 ...
 *   <li>{@link edu.kit.cockpit.sfmdesigner.servicefeaturemodel.ServiceFeature#getAttributes <em>Attributes</em>}</li>
 *   <li>{@link edu.kit.cockpit.sfmdesigner.servicefeaturemodel.ServiceFeature#getGroupRelationship <em>Group Relationship</em>}</li>
 *   <li>{@link edu.kit.cockpit.sfmdesigner.servicefeaturemodel.ServiceFeature#getRequires <em>Requires</em>}</li>
 *   <li>{@link edu.kit.cockpit.sfmdesigner.servicefeaturemodel.ServiceFeature#getExcludes <em>Excludes</em>}</li>
 *   <li>{@link edu.kit.cockpit.sfmdesigner.servicefeaturemodel.ServiceFeature#getServiceFeatures <em>Service Features</em>}</li>
...
public interface ServiceFeature extends EObject {
	 ...
	 * @see edu.kit.cockpit.sfmdesigner.servicefeaturemodel.ServicefeaturemodelPackage#getServiceFeature_Attributes()
	 ...
	 * @see edu.kit.cockpit.sfmdesigner.servicefeaturemodel.ServicefeaturemodelPackage#getServiceFeature_GroupRelationship()
	 * @model containment="true"
	 * @generated
	 */
	...
	/**
	 * Sets the value of the '{@link edu.kit.cockpit.sfmdesigner.servicefeaturemodel.ServiceFeature#getGroupRelationship <em>Group Relationship</em>}' containment reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see edu.kit.cockpit.sfmdesigner.servicefeaturemodel.ServicefeaturemodelPackage#getServiceFeature_Requires()
	 * @model containment="true"
	 * @generated
	 */
	 ...
	 * @see edu.kit.cockpit.sfmdesigner.servicefeaturemodel.ServicefeaturemodelPackage#getServiceFeature_Excludes()
	 * @model containment="true"
	 * @generated
	 */
	 ...
	 * @see edu.kit.cockpit.sfmdesigner.servicefeaturemodel.ServicefeaturemodelPackage#getServiceFeature_ServiceFeatures()
	 * @model containment="true"
	 * @generated
	 */
