 ...
 * <ul>
 *   <li>{@link edu.kit.cockpit.sfmdesigner.servicefeaturemodel.OR#getMinFeaturesToChoose <em>Min Features To Choose</em>}</li>
 *   <li>{@link edu.kit.cockpit.sfmdesigner.servicefeaturemodel.OR#getMaxFeaturesToChoose <em>Max Features To Choose</em>}</li>
 * </ul>
 * </p>
 *
 * @see edu.kit.cockpit.sfmdesigner.servicefeaturemodel.ServicefeaturemodelPackage#getOR()
 * @model
 * @generated
 */
public interface OR extends GroupRelationship {
	 ...
	 * @see edu.kit.cockpit.sfmdesigner.servicefeaturemodel.ServicefeaturemodelPackage#getOR_MinFeaturesToChoose()
	 * @model
	 * @generated
	 */
	...
	/**
	 * Sets the value of the '{@link edu.kit.cockpit.sfmdesigner.servicefeaturemodel.OR#getMinFeaturesToChoose <em>Min Features To Choose</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see edu.kit.cockpit.sfmdesigner.servicefeaturemodel.ServicefeaturemodelPackage#getOR_MaxFeaturesToChoose()
	 * @model
	 * @generated
	 */
	...
	/**
	 * Sets the value of the '{@link edu.kit.cockpit.sfmdesigner.servicefeaturemodel.OR#getMaxFeaturesToChoose <em>Max Features To Choose</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
