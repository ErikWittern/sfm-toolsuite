...
/**
 * This is the item provider adapter for a {@link edu.kit.sfm.servicefeaturemodel.Excludes} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class ExcludesItemProvider
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Excludes_serviceFeature_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Excludes_serviceFeature_feature", "_UI_Excludes_type"),
				 ServicefeaturemodelPackage.Literals.EXCLUDES__SERVICE_FEATURE,
				 true,
				 false,
				 true,
				 null,
	...
	public String getText(Object object) {
		...
		if(!(((Excludes)object).getServiceFeature() == null)){
			returnString = getString("_UI_Excludes_type") + ": " + ((Excludes)object).getServiceFeature().getName();
		}
		return returnString;
	}
