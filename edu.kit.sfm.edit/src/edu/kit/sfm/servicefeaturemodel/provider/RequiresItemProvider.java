		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Requires_serviceFeature_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Requires_serviceFeature_feature", "_UI_Requires_type"),
				 ServicefeaturemodelPackage.Literals.REQUIRES__SERVICE_FEATURE,
				 true,
				 false,
				 true,
				 null,
