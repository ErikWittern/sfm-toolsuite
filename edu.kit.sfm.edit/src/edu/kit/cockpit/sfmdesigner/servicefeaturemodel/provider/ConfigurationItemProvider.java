...
/**
 * This is the item provider adapter for a {@link edu.kit.cockpit.sfmdesigner.servicefeaturemodel.Configuration} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class ConfigurationItemProvider
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 ServicefeaturemodelPackage.Literals.CONFIGURATION__NAME,
				 true,
				 false,
				 false,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 ServicefeaturemodelPackage.Literals.CONFIGURATION__ID,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
	...
	/**
	 * This adds a property descriptor for the Service Features feature.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	protected void addServiceFeaturesPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Configuration_serviceFeatures_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Configuration_serviceFeatures_feature", "_UI_Configuration_type"),
				 ServicefeaturemodelPackage.Literals.CONFIGURATION__SERVICE_FEATURES,
				 true,
				 false,
				 true,
				 null,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 ServicefeaturemodelPackage.Literals.CONFIGURATION__DESCRIPTION,
				 true,
				 true,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(ServicefeaturemodelPackage.Literals.CONFIGURATION__PREFERENCES);
			childrenFeatures.add(ServicefeaturemodelPackage.Literals.CONFIGURATION__ATTRIBUTES);
		}
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(ServicefeaturemodelPackage.Literals.CONFIGURATION__PREFERENCES,
				 ServicefeaturemodelFactory.eINSTANCE.createPreference()));

		newChildDescriptors.add
			(createChildParameter
				(ServicefeaturemodelPackage.Literals.CONFIGURATION__ATTRIBUTES,
