...
/**
 * This is the item provider adapter for a {@link edu.kit.cockpit.sfmdesigner.servicefeaturemodel.Service} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class ServiceItemProvider
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 ServicefeaturemodelPackage.Literals.SERVICE__DESCRIPTION,
				 true,
				 true,
				 false,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 ServicefeaturemodelPackage.Literals.SERVICE__NAME,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(ServicefeaturemodelPackage.Literals.SERVICE__SERVICE_FEATURE_DIAGRAM);
			childrenFeatures.add(ServicefeaturemodelPackage.Literals.SERVICE__CONFIGURATIONS);
			childrenFeatures.add(ServicefeaturemodelPackage.Literals.SERVICE__ATTRIBUTE_TYPES);
		}
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(ServicefeaturemodelPackage.Literals.SERVICE__SERVICE_FEATURE_DIAGRAM,
				 ServicefeaturemodelFactory.eINSTANCE.createServiceFeatureDiagram()));

		newChildDescriptors.add
			(createChildParameter
				(ServicefeaturemodelPackage.Literals.SERVICE__CONFIGURATIONS,
				 ServicefeaturemodelFactory.eINSTANCE.createConfigurations()));

		newChildDescriptors.add
			(createChildParameter
				(ServicefeaturemodelPackage.Literals.SERVICE__ATTRIBUTE_TYPES,
				 ServicefeaturemodelFactory.eINSTANCE.createAttributeTypes()));
	}
