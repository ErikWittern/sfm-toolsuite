...
public class ValuationAnalyzerTest {
	...
	public void setUp() throws Exception {
		...
		URL url = getClass().getClassLoader().getResource(
				CVSrvContext.SFM_ANALYZER_TEST_FILENAME);
	...
	public void testComputeConfigurationPreferenceVector() {
		...
		//float[] fa = AotearoaAdapter.computeConfigurationPreferenceVector(service, vote);
		//Erik:
		float[] fa = SimpleAHPAdapter.computeConfigurationPreferenceVector(service, vote);
	...
	protected static VoteE constructVote() {
		...
		pref1.setAttributeTypeA("AttLowerBetter");
